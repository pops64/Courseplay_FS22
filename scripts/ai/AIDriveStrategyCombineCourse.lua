...
-- Setting to permit looking for Combines out side of the Field
...
function AIDriveStrategyCombineCourse:measureBackDistance()
    ...
    local nx, ny, nz = localDirectionToWorld(self.vehicle:getAIDirectionNode(), 0, 0, 1)
    local x, y, z = localToWorld(self.vehicle:getAIDirectionNode(), 0, 1.5, -self.maxBackDistance)
